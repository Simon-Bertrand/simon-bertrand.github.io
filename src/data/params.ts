export const menus = [
  ...
  },
  {
    ...
    href: "/blog/",
    icon:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2M8 17H6v-2h2v2m0-4H6v-2h2v2m0-4H6V7h2v2m10 8h-8v-2h8v2m0-4h-8v-2h8v2m0-4h-8V7h8v2Z"/></svg>',
  },
  {
    name: "Éducation",
    href: "/education",
  ...
  },
  {
    ...
    href: "/experiences",
    icon:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M4 6h16v10H4m16 2a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H4c-1.11 0-2 .89-2 2v10a2 2 0 0 0 2 2H0v2h24v-2h-4Z"/></svg>',
  },
  {
    name: "Projets",
    href: "/projects",
    icon:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M4 4h7v7H4V4m9 0h7v7h-7V4M4 13h7v7H4v-7m9 0h7v7h-7v-7m-7-7v3h3V6H6m9 0v3h3V6h-3M6 15v3h3v-3H6m9 0v3h3v-3h-3Z"/></svg>',
  },
  {
    name: "Ressources",
    href: "/ressources",
    icon:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M15 7h5.5L15 1.5V7M8 0h8l6 6v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2M4 4v18h16v2H4a2 2 0 0 1-2-2V4h2Z"/></svg>',
  },
];
...
export const socialMedias = [
  ...
  },
  {
    name: "Google Scholar",
    icon:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 24a7 7 0 1 1 0-14a7 7 0 0 1 0 14ZM3.6 8.7L12 0l8.4 8.7l-3.1 2.5A8.96 8.96 0 0 0 12 9.5c-1.95 0-3.75.62-5.23 1.68L3.6 8.7Z"/></svg>',
...
export const experienceItems: {
  ...
  },
  {
    ...
    description:
      "Réserviste R01 de la Garde Nationale spécialisé en protection et défense",
  ...
  },
  {
    ...
    description:
      "Ajout de fonctionnalités de vision par ordinateur et d'IA pour la caméra GateKeeper",
    date: "2023 (6 mois)",
    src: "Thales.png",
  },
  {
